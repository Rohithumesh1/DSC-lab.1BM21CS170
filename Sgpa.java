...
if(calculate_grade_point(marks[i])==-1) return -1.0f; 
else 
{ 
result = result +(float) 
(calculate_grade_point(marks[i])*credits[i]); } 
} 
return (result/sum_of_credits); 
}
int calculate_grade_point(int marks) { 
if(marks>=90) 
return 10; 
...
void display(int n,float result) { 
System.out.println("\n"); 
